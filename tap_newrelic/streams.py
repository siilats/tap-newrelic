...
class MobileAppStream(NewRelicStream):
    ...
    schema = PropertiesList(
        ...
        Property("occurrence_timestamp", IntegerType),
        ...
        Property("reported_timestamp_ms", IntegerType),
        ...
        Property("session_crashed", BooleanType),
        ...
        # Property("unread_messages", NumberType),
